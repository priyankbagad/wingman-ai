...
export const LampContainer = ({ children, className }) => {
  return (
    <div
      className={cn("relative flex flex-col items-center justify-center min-h-screen overflow-hidden bg-slate-950 w-full z-0", className)}
      style={{
        backgroundImage: "radial-gradient(circle at 1px 1px, #1e1e2e 1px, transparent 0)",
        backgroundSize: "32px 32px",
      }}
    >
      <div className="absolute top-0 left-0 right-0 flex h-[55vh] scale-y-125 items-center justify-center isolate z-0">
        <motion.div
